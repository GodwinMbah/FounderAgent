  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--background)] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-[-10%] right-[-5%] w-[50%] h-[50%] rounded-full opacity-40"
          style={{ background: "radial-gradient(circle, rgba(139,92,246,0.1) 0%, transparent 60%)", filter: "blur(100px)" }} />
        <div className="absolute bottom-[-10%] left-[-5%] w-[45%] h-[45%] rounded-full opacity-30"
      ...
      <div className="relative w-full max-w-md px-6">
        ...
        <div className="relative rounded-2xl border border-[var(--border)] bg-gradient-to-b from-[#111827] to-[#0c0c14] p-8 shadow-2xl">
          {/* Top accent line */}
          <div className="absolute top-0 left-4 right-4 h-px bg-gradient-to-r from-transparent via-[var(--highlight)]/40 to-transparent" />

          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-[var(--foreground)] mb-1">Create your account</h1>
            <p className="text-sm text-[var(--muted-foreground)]">Start your AI-powered finance journey</p>
          </div>
          ...
          <form action={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label htmlFor="name" className="block text-xs font-medium text-[var(--muted-foreground)] uppercase tracking-wider">
                Full Name
              </label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              <label htmlFor="companyName" className="block text-xs font-medium text-[var(--muted-foreground)] uppercase tracking-wider">
                Company Name
              </label>
              <div className="relative">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-[var(--muted-foreground)]/70">Minimum 8 characters</p>
            </div>

            <button
              type="submit"
              disabled={loading}
              className="group w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[var(--highlight)] to-[#7c3aed] py-2.5 text-sm font-semibold text-white shadow-lg shadow-[var(--highlight)]/20 hover:shadow-[var(--highlight)]/30 hover:from-[#a78bfa] hover:to-[var(--highlight)] transition-all disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-[var(--muted-foreground)]">
              ...
              <Link href="/login" className="text-[var(--accent)] hover:text-[var(--accent)]/80 font-medium transition-colors">
                Sign in
              </Link>
            </p>
          </div>
