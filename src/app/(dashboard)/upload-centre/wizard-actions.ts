...
export async function confirmAndProcess(
  ...
  try {
    ...
    const summary: ImportSummary = {
      ...
      rowsIncludedInCashMovement: pipelineResult.reconciliation?.rowsIncludedInCashMovement ?? 0,
      rowsIncludedInProfitAndLoss: pipelineResult.reconciliation?.rowsIncludedInProfitAndLoss ?? 0,
      rowsIncludedInDebtTracking: pipelineResult.reconciliation?.rowsIncludedInDebtTracking ?? 0,
      rowsIncludedInOwnerMovement: pipelineResult.reconciliation?.rowsIncludedInOwnerMovement ?? 0,
      rowsIncludedInTaxReporting: pipelineResult.reconciliation?.rowsIncludedInTaxReporting ?? 0,
      rowsIncludedInDataQualityReporting: pipelineResult.reconciliation?.rowsIncludedInDataQualityReporting ?? 0,
